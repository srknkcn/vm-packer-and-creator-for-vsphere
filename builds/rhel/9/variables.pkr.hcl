...
variable "ssh_port" {
  type        = string
  description = "The guest operating system ssh port."
  default     = "22"
}

variable "ntp_server1" {
  type        = string
  description = "The guest operating system ntp server 1."
  default     = "ntp0.ntp-servers.net"
}

variable "ntp_server2" {
  type        = string
  description = "The guest operating system ntp server 2."
